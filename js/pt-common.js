...
$(window).load(function () {
	...
	// 연혁 탭
	var tabCont04 = $('.bro_mod_history.sty03 .history').children();
	tabCont04.each(function () {
		var year = $(this).children('span').html();
		$(this).addClass(year);
	});
	var tabArray04 = Array();
	tabCont04.each(function () {
		tabArray04.push($(this).attr("class"));
	})
	var arrayList04 = $.map(tabArray04, function (value) {
		return "<a href='javascript:vold'" + "data-tab=" + value + ">" + value + "</a>";
	})
	$('.bro_mod_history.sty03 .tabs').html(arrayList04);
	...
	var tabCont02 = $('.bro_mod_biz.sty03 .bizDiv').children();
	tabCont02.each(function () {
	...
	var tabArray02 = Array();
	tabCont02.each(function () {
		tabArray02.push($(this).attr("class"));
	})
	var arrayList02 = $.map(tabArray02, function (value) {
		return "<li><a href='javascript:vold'" + "data-tab=" + value + ">" + value + "</a></li>";
	})
	$('.bro_mod_biz.sty03 .tabs').html(arrayList02);
	...
	var tabCont03 = $('.bro_mod_biz.sty04 .bizDiv').children();
	tabCont03.each(function () {
		var title = $(this).children('h4').html();
		$(this).addClass(title);
	});
	var tabArray03 = Array();
	tabCont03.each(function () {
		tabArray03.push($(this).attr("class"));
	})
	var arrayList03 = $.map(tabArray03, function (value) {
		return "<li><a href='javascript:vold'" + "data-tab=" + value + ">" + value + "</a></li>";
	})
	$('.bro_mod_biz.sty04 .tabs').html(arrayList03);
	...
	$('.mag_mod_interview.sty02 .qa_ceo').attr('id', 'mag_itv02_ceo');
	$('.mag_mod_interview.sty02 .qa_mng').attr('id', 'mag_itv02_mng');
	$('.mag_mod_interview.sty02 .qa_emp').attr('id', 'mag_itv02_emp');
	...
	$(".mag_mod_interview.sty02 .tab_container").each(function () {
		$(this).children('.tabs').children("li:first").addClass("active"); //Activate first tab
		$(this).children(".tab_content").first().show();
	});
	...
	$(".mag_mod_interview.sty06 .ivCeo").append('<div class="swiper-button-prev"></div>');
	$(".mag_mod_interview.sty06 .ivCeo").append('<div class="swiper-button-next"></div>');
	...
	$(".mag_mod_interview.sty06 .ivMng").append('<div class="swiper-button-prev"></div>');
	$(".mag_mod_interview.sty06 .ivMng").append('<div class="swiper-button-next"></div>');
	...
	$(".mag_mod_interview.sty06 .ivEmp").append('<div class="swiper-button-prev"></div>');
	$(".mag_mod_interview.sty06 .ivEmp").append('<div class="swiper-button-next"></div>');
	...
	$(".inf_mod_interview.sty03 .ivCeo").append('<div class="swiper-button-prev"></div>');
	$(".inf_mod_interview.sty03 .ivCeo").append('<div class="swiper-button-next"></div>');
	...
	$(".inf_mod_interview.sty03 .ivMng").append('<div class="swiper-button-prev"></div>');
	$(".inf_mod_interview.sty03 .ivMng").append('<div class="swiper-button-next"></div>');
	...
	$(".inf_mod_interview.sty03 .ivEmp").append('<div class="swiper-button-prev"></div>');
	$(".inf_mod_interview.sty03 .ivEmp").append('<div class="swiper-button-next"></div>');
