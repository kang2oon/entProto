	...
	switch(item){
		...
		case "mod_header02":
			var contents = '<div class="module-wrap edit_wrap com_mod_header sty02">\n'
						 ...
						 + '			<dl class="clearfix">\n'
						 + '				<dt>업종</dt>\n'
						 + '				<dd class="incCate">업종</dd>\n'
						 + '				<dt>대표자</dt>\n'
						 + '				<dd class="ceo">대표자</dd>\n'
						 + '				<dt>기업형태</dt>\n'
						 + '				<dd class="comForm">기업형태</dd>\n'
						 + '			</dl>\n'
						 + '			<div class="action fc_000 clearfix">\n'
						 + '				<a href="javascript:void(0);" id="scrapYn" onclick="onCntNew();">관심기업 등록<i>♥</i></a>\n'
						 + '				<a href="javascript:void(0);" id="copyUrlNew" onclick="copyUrlNew();" data-clipboard-action="copy">페이지 URL 복사<i>→</i></a>\n'
						 + '			</div>\n'
						 + '		</div>\n'
						 + '	</div>\n'
						 + '</div>\n\n';
		...
		case "sns_mod_info":
			var contents = ''
						 ...
						 + '         	<div class="cnt lastEmployeeState"><span class="fiProfit lastTotal">-</span></div>\n'
						 + '         	</li>\n'
						 + '         	<li>\n'
		...
		case "rec_mod_percent02":
			var contents = ''
						 ...
						 + '				<p>규모형태</p>\n'
						 + '				<div class="circle">\n'
						 + '					<p class="bpScale">상위 <strong>-</strong>%</p>\n'
						 + '				</div>\n'
						 + '			</div>\n'
						 + '			<div class="profit">\n'
						 + '				<p>수익성</p>\n'
						 + '				<div class="circle">\n'
						 + '					<p class="bpProfitability">상위 <strong>-</strong>%</p>\n'
						 + '				</div>\n'
						 + '			</div>\n'
						 + '			<div class="stable">\n'
						 + '				<p>안정성</p>\n'
						 + '				<div class="circle">\n'
						 + '				<p class="bpStability">상위 <strong>-</strong>%</p>\n'
						 + '				</div>\n'
						 + '			</div>\n'
						 + '			<div class="growth">\n'
						 + '				<p>성장성</p>\n'
						 + '				<div class="circle">\n'
						 + '					<p class="bpGrowthability">상위 <strong>-</strong>%</p>\n'
						 + '				</div>\n'
						 + '			</div>\n'
						 + '			</div>\n'
						 + '		</div>\n'
		...
		case "mag_mod_biz06":
			var contents = ''
						 ...
						 + '		<div class="tab_wrap">\n'
						 + '			<ul class="tabs">\n'
						 + '				<li><a href="javascript:;" data-tab="타이틀1" class="on">타이틀1</a></li>\n'
						 + '				<li><a href="javascript:;" data-tab="타이틀2" class="">타이틀2</a></li>\n'
						 + '				<li><a href="javascript:;" data-tab="타이틀3" class="">타이틀3</a></li>\n'
						 + '				<li><a href="javascript:;" data-tab="타이틀4" class="">타이틀4</a></li>\n'
						 + '				<li><a href="javascript:;" data-tab="타이틀5" class="">타이틀5</a></li>\n'
						 + '			</ul>\n'
						 + '		</div>\n'
						 + '		<div class="biz_wrap">\n'
						 + '			<div class="bizDiv">\n'
		...
		case "mod_history02":
			var contents = ''
						 ...
						 + '		<div class="tab_wrap">\n'
						 + '			<div class="tabs">\n'
						 + '				<a href="javascript:;" data-tab="2021" class="on">2021</a>\n'
						 + '				<a href="javascript:;" data-tab="2018" class="">2018</a>\n'
						 + '			</div>\n'
						 + '		</div>\n'
						 + '		<div class="history_wrap">\n'
						 + '			<div class="cont">\n'
		...
		case "mod_interview03":
			...
			+ ' 	<div class="cnt-container">\n'
			+ ' 		<div class="swiper-container interview_swiper">\n'
			+ ' 			<div class="swiper-wrapper">\n'
			+ ' 				<div class="swiper-slide">\n'
			+ ' 					<div class="iv_wrap qa_ceo">\n'
			+ ' 						<div class="interview_txt">\n'
			+ ' 							<p>끊임없이 성장하는 <br />더 나은 세상을 만들어 갑니다. </p>\n'
			+ ' 							<h3>CEO 인터뷰</h3>\n'
			+ ' 						</div>\n'
			+ ' 						<div class="ivCeoPhoto photo">\n'
			+ ' 							<img src="/images/mag_interview05_emp.png" alt="ceo">\n'
			+ ' 						</div>\n'
			...
			+ ' 									<div class="swiper-slide">\n'
			+ ' 										<div class="q">질문</div>\n'
			+ ' 										<div class="a">답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변</div>\n'
			+ ' 								</div>\n'
			+ ' 									<div class="swiper-slide">\n'
			+ ' 										<div class="q">질문</div>\n'
			+ ' 										<div class="a">답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변답변</div>\n'
			...
			+ ' 						</div>\n'
			+ ' 						<div class="ivMngPhoto photo">\n'
			+ ' 							<img src="/images/mag_interview05_emp.png" alt="인사담당자">\n'
			+ ' 						</div>\n'
			+ ' 						<div class="itv_border">\n'
			+ ' 							<div class="swiper ivMng">\n'
			+ ' 								<div class="swiper-wrapper">\n'
			...
			+ ' 						</div>\n'
			+ ' 						<div class="ivEmpPhoto photo">\n'
			+ ' 							<img src="/images/mag_interview05_emp.png" alt="재직자">\n'
			+ ' 						</div>\n'
			+ ' 						<div class="itv_border">\n'
			+ ' 							<div class="swiper ivEmp">\n'
			+ ' 								<div class="swiper-wrapper">\n'
			...
			+ ' 	</div>\n'
			+ '<script>\n'
			+ ' var ceoIvSlider = new Swiper(\'.mag_mod_interview.sty05 .interview_swiper\', {\n' 
			+ ' 								slidesPerView: 1,\n' 
			+ ' 								spaceBetween: 0,\n' 
			+ ' 								allowTouchMove: false,\n' 
			+ ' 								navigation: {\n' 
		   + ' 								nextEl: ".mag_mod_interview.sty05  .swiper-button-next",\n' 
		   + ' 								prevEl: ".mag_mod_interview.sty05  .swiper-button-prev"\n' 
		   + ' 								},\n' 
		   + ' 							})\n' 
...
break;
		case "mod_interview04":
			var contents = ''
						 ...
						 + '		<ul class="tabs">\n'
						 + '			<li class="active"><a href="javascript:;" data-tab="mag_itv02_ceo">CEO 인터뷰</a></li>\n'
						 + '			<li><a href="javascript:;" data-tab="mag_itv02_mng">채용담당자</a></li>\n'
						 + '			<li><a href="javascript:;" data-tab="mag_itv02_emp">신입사원</a></li>\n'
						 + '		</ul>\n'
		...
		case "mod_interview05":
			var contents = ''
						 ...
						 + '</div>\n'
						 + '<script>\n'
						 + '	var itvSlider = new Swiper(".mag_mod_interview.sty06 .interview_swiper", {\n'
						 + '		slidesPerView: 1,\n'
						 + '		spaceBetween: 0,\n'
						 + '		allowTouchMove: false,\n'
						 + '		navigation: {\n'
						 + '			nextEl: ".mag_mod_interview.sty06  .swiper-button-next",\n'
						 + '			prevEl: ".mag_mod_interview.sty06  .swiper-button-prev"\n'
						 + '		}\n'
						 + '		})\n'
		...
		case "mod_interview06":
			var contents = ''
						 ...
						 + ' 						<div class="interview_txt">\n'
						 + ' 							<div class="ivCeoPhoto photo">\n'
						 + ' 								<img src="/images/bro_interview02_ceo.png" alt="CEO">\n'
						 + ' 							</div>\n'
						 + ' 						<div class="txt">\n'
						 + ' 							<h3>CEO 인터뷰</h3>\n'
						 + ' 							<strong>도전, 열정, 창의 가장 행복한 자리는 일자리입니다.</strong>\n'
						 + ' <p>도전과 실패를 두려워하지 않으며, 문제 처리에 있어 관행적인 방식보다는 새로운 방식을 선호하고 능동적으로 행동한다. 지속가능한 가치를 추구하고, 고객의 니즈 충족과 회사 이익에 부합되는 대안을 효과적으로 제시한다. 잠재적인 기회를 찾아내기 위해 관심을 보이고, 새로운 기회를 포착하면 신속히 결단하여 경쟁력 확보에 힘쓴다. </p>\n'
						 + ' 					</div>\n'
						 + ' 				</div>\n'
						 + ' 			</div>\n'
						 + ' 		<div class="bg">\n'
						 ...
						 + '</div>\n'
						 + '<script>\n'
						 + ' 	var ceoIvSlider = new Swiper(\'.bro_mod_interview.sty02 .interview_swiper\', {\n'
						 + ' 		slidesPerView: 1,\n'
						 + ' 		spaceBetween: 0,\n'
						 + ' 		allowTouchMove: false,\n'
						 + ' 		navigation: {\n'
						 + ' 				nextEl: ".bro_mod_interview.sty02  .swiper-button-next",\n'
						 + ' 				prevEl: ".bro_mod_interview.sty02  .swiper-button-prev"\n'
						 + ' 				}\n'
						 + ' 		});\n'
		...
		case "mod_interview08":
			var contents = ''
						 ...
						 + '				</div>\n'
						 + '			</div>\n'
						 + '			<a href="javascript:;" class="load_more">더보기</a>\n'
						 + '		</div>\n'
						 + '	</div>\n'
						 + '	<div class="bg">\n'
						 + '		<div class="cnt-container">\n'
		...
		case "mod_interview09":
			var contents = ''
						 ...
						 + '						</div>\n'
						 + '					</div>\n'
						 + '				<a href="javascript:;" class="load_more">더보기</a></div>\n'
						 + '			</div>\n'
						 + '		</div>\n'
						 + '	</div>\n'
						 + '</div>\n'
		...
		case "mod_interview10":
			var contents = ''
						 ...
						 + ' 		</p>\n'
						 + ' 		<div class="ivCeoPhoto photo">\n'
						 + ' 		<img src="./images/rec_interview05_ceo.png" alt="ceo">\n'
						 + ' </div>\n'
						 + ' <div class="swiper ivCeo">\n'
						 + ' 	<div class="swiper-wrapper">\n'
						 + ' 		<div class="swiper-slide">\n'
						 ...
						 + '				<ul class="tab">\n'
						 + '					<li class="active"><a href="javascript:;" data-tab="rec_itv05_tab1">채용담당자 인터뷰</a></li>\n'
						 + '					<li class=""><a href="javascript:;" data-tab="rec_itv05_tab2">신입사원 인터뷰</a></li>\n'
						 + '				</ul>\n'
		...
		case "mod_finance07":
			var contents = ''
						 ...
						 + '		<div class="tit_wrap">\n'
						 + '			<hr>\n'
						 + '			<div>끊임없이 성장하는<br>더 나은 세상을 만들어 갑니다.</div>\n'
		...
		case "mod_welfare13":
			var contents = ''
						 ...
						 + '	<div class="cnt-container">\n'
						 + '		<div class="tab">\n'
						 + '			<a href="javascript:;" class="on" data-tab="culture_wrap">조직문화</a>\n'
						 + '			<a href="javascript:;" data-tab="welfare_wrap" class="">복리후생</a>\n'
						 + '		</div>\n'
						 + '		<div class="conts">\n'
		...
		case "mod_welfare15":
			var contents = ''
						 + '<div class="module-wrap edit_wrap rec_mod_welfare sty05">\n'
						 + '	<div class="cnt-container">\n'
						 + '		<div class="welfare_wrap">\n'
						 + '			<h3>복리후생</h3>\n'
						 + '			<div class="swiper dvWelfare">\n'
						 ...
						 + '</div>\n'
						 + '<script>\n'
						 + '	var welfareSlider = new Swiper(".rec_mod_welfare.sty05 .dvWelfare", {\n'
						 + '		slidesPerView: 3,\n'
						 + '		spaceBetween: 15,\n'
						 + '		navigation: {\n'
						 + '			nextEl: ".rec_mod_welfare.sty05  .swiper-button-next",\n'
						 + '			prevEl: ".rec_mod_welfare.sty05  .swiper-button-prev"\n'
						 + '		},\n'
						 + '		breakpoints: {\n'
						 + '			280: {\n'
						 + '				slidesPerView: 1,\n'
		...
		case "mod_emp01":
			var contents = ''
						 ...
						 + '			type: "line",\n'
						 + '			columns: [\n'
						 + '				["입사자", 55, 33, 11,55, 33, 11,55, 33, 11,55, 33],\n'
						 + '				["퇴사자", 22, 13, 14,25, 33, 11,55, 33, 11,55, 33],\n'
						 + '				["총원", 11, 23, 15,15, 33, 11,55, 33, 11,55, 33]\n'
						 + '			],\n'
						 + '			colors: {\n'
						 + '				입사자: "rgb(0, 174, 239)",\n'
						 + '				퇴사자: "rgb(208, 208, 208)",\n'
						 ...
						 + '			x: {\n'
						 + '				type: "category",\n'
						 + '					categories: ["202110", "202109", "202108", "202107","202106","202105","202104","202103","202102","202101","202012","202111"],\n'
						 + '				padding: {\n'
						 + '					left: .2,\n'
						 + '					right: .2\n'
						 + '				},\n'
		...
		case "mod_emp02":
			var contents = ''
						 ...
						 + '			columns: [\n'
						 + '				["입사자", 55, 33, 11,55, 33, 11,55, 33, 11,55, 33],\n'
						 + '				["퇴사자", 55, 33, 11,55, 33, 11,55, 33, 11,55, 33],\n'
						 + '				["총원", 55, 33, 11,55, 33, 11,55, 33, 11,55, 33]\n'
						 + '			],\n'
						 + '			colors: {\n'
						 + '				입사자: "rgb(0, 200, 200)",\n'
						 + '				퇴사자: "rgb(205, 198, 198)",\n'
